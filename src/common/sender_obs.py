...
class SenderMonitorInterval():
    def __init__(self,
                 ...
                 packet_size=1500,
                 extra_features=None):
        self.features = extra_features.copy() if extra_features is not None else {}
...
SENDER_MI_METRICS = [
    ...
    SenderMonitorIntervalMetric("buffer utilization", lambda mi: mi.features.get("buffer utilization", 0.0), 0.0, 1.0)
]
